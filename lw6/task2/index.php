...
<html lang="ru">
  <head>
    ...
    <link src="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700&display=swap&subset=cyrillic-ext" rel="stylesheet">
  </head>
  <body>    
      ...
      <div class="block_about_films">
        ...
        <div class="films">
          <div class="film_block">
            ...
            <div class="film_title">Побег из Шоушенка</div>
          ...
          <div class="film_block">
            ...
            <div class="film_title">Наркоз</div>
            <p class="film_description">
          ...
          <div class="film_block">
            ...
            <div class="film_title">Астрал</div>
            <p class="film_description">
          ...
          <div class="film_block">
            ...
            <div class="film_title">Гравитация</div>
            <p class="film_description">
